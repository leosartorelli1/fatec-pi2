...
if ($resultado) {
    ...
    try {
        ...
        $sql_estagio = "INSERT INTO tb_estagios (horario_inicio, horario_termino, inicio_intervalo, termino_intervalo, total_horas, data_inicio, data_termino, salario, apolice, seguradora, fk_id_empresa, fk_id_aluno) 
                        VALUES (:horario_inicio, :horario_termino, :inicio_intervalo, :termino_intervalo, :total_horas, :data_inicio, :data_termino, :salario, :apolice, :seguradora, :fk_id_empresa, :fk_id_aluno)";
