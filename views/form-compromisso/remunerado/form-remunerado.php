...
<head>
   ...
   <link rel="stylesheet" href="style-remunerado.css">
...
<header>
    ...
    <h2>Preencha o termo de compromisso (Remunerado):</h2>
    ...
    <form id="termo" action="processar-formulario.php" method="post">
       ...
       <label for="cnpj">CNPJ da Empresa:</label>
        ...
        <input type="time" id="termino_intervalo" name="termino_intervalo" required></div>
        ...
        <!-- Apolice. -->
        <label for="apolice">Número da Apólice do Seguro:</label>
        <input type="text" id="apolice" name="apolice" required>

        <div><label for="seguradora">Nome da Seguradora:</label>
