...
<header>
    ...
    <h2>O relatório parcial deve ser entregue a cada seis meses.</h2>
        <span class="divisor"></span>
        <p>
        O relatório parcial de estágio é um documento que o estagiário deve apresentar periodicamente ao longo do período de estágio. Esse relatório serve para acompanhar e avaliar o progresso do estagiário e as atividades desenvolvidas até o momento.
        </p>
        <strong><p>Clique no botão abaixo para preencher o relatório</p></strong>
    <a class="link" href="relatorio.php">Relatório Parcial</a>
    </div>

    <div class="cps-principal">
    <h2>Upload do relatório preenchido e assinado :</h2>
