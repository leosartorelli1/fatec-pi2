...
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@100..900&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="style-parcial.css">
...
<header>
        ...
        <div class="cps-principal">
            ...
            <h2>Relatório Parcial</h2>

            <span class="divisor"></span>
    <form action="processar-relatorio-parcial.php" method="POST">

        <h2>Olá, <strong><?php echo $nome; ?></strong>!</h2><h2>
        Antes de emitirmos o seu relatório parcial, precisamos confirmar algumas informações</h2> 
        
        <div class="cps-principal-aluno">
        <h3>Seus dados :</h3> 

        Seu nome : <strong><?php echo $nome; ?></strong> <br>

        Seu curso : <strong><?php echo $curso; ?></strong><br>
        Seu RA : <strong><?php echo $ra; ?></strong><br>
        </div>
