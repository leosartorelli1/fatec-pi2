    ...
    <header>
        ...
        <div>
            <nav>
                <ul>
                    <li><a href="#">Home</a></li>
                    <li><a href="views/form-compromisso/form-compromisso.php">Termo de Compromisso</a></li>
                    <li><a href="views/form-atividade/form-atividade.php">Plano de Atividades</a></li>
